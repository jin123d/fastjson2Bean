package com.jin123d.net.convert;
...
public class ReqJsonUtils {
    ...
    public static <T> T parseHttpResult(TypeInfo type, String jsonData) throws JSONException {
        ...
        if (isCollection) {//处理collection
            ...
            result = (T) JSONObject.parseObject(jsonData, type.getType(), Feature.InitStringFieldAsEmpty);
            ...
            if (isPrimitiveOrWrapper(componentType)) {
                result = (T) parseObject(jsonData, Feature.InitStringFieldAsEmpty);
            } else {
                //处理自定义对象
                result = (T) parseObject(jsonData, componentType, Feature.InitStringFieldAsEmpty);
            }
        }
        return result;
    }
